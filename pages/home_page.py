...
class HomeKaraokePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.nav_buttons = {}
        self.nav_targets = {"Home": "HomeKaraokePage", "Karaoke": "LyricsPage", 
                           "SongBook": "SongbookPage", "Settings": "SettingsPage"}
        
        tabs = [("Home", "HomeKaraokePage"), ("Karaoke", "LyricsPage"), 
                ("SongBook", "SongbookPage"), ("Settings", "SettingsPage")]
        for tab, target in tabs:
            btn = tk.Button(nav_frame, text=tab, bg=nav_blue, fg="white", font=font_style, 
